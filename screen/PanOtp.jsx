...
const PanOtp = ({ navigation, route }) => {
  ...
  const handleVerifyOtp = () => {
    ...
    const otpString = otp.join('');
    // Simulate OTP verification (replace with authorized API call)
    console.log(`Verifying OTP ${otpString} for PAN: ${pan}`);
    // navigation.navigate('PanVerificationSuccess', { pan, otp: otpString }); // Uncomment for navigation
  };
  ...
  const handleResendOtp = () => {
    ...
    // Simulate OTP resend (replace with authorized API call)
    console.log(`Resending OTP for PAN: ${pan}`);
  };
        ...
        >
          <Animated.View style={[styles.content, { opacity: fadeAnim }]}>
            ...
            <LinearGradient colors={['#1E3A8A', '#3B82F6']} style={styles.formContainer}>
              <Text style={styles.title}>PAN OTP Verification</Text>
